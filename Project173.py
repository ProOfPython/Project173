...
class parent():
    ...
    def chemicalEngineer(name):
        chemicalAry = ['Berkeley Labs', 'BASF']
        randChemical = random.randint(0,1) 
        label_selected_chemical['text'] = name + ' has been allowed to ' + chemicalAry[randChemical]
        #define variale company_list and inside it store the list of companies of your choice in square bracktes.
